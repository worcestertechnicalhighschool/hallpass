...
class HallpassAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def pre_social_login(self, request, sociallogin):
        ...
        # print("social " + sociallogin.user.email)
        # print(username)
       
        
        username = sociallogin.user.email.split('@')[0] #username
        domain = sociallogin.user.email.split('@')[1] #domain
